...
export default function ReviewPanel({
  ...
  return (
    <div className="@container flex flex-col md:flex-row lg:flex-col rounded-card bg-surface-panel p-5">
      ...
      <div className="m-3 flex flex-col">
        <div className="border-t md:border-none lg:border-t border-surface-border pt-4">
          <div className="flex md:flex-col lg:flex-row items-start gap-4">
            ...
            <div className="flex flex-1 flex-col items-end gap-1.5 md:flex-row items-center md:justify-between lg:flex-col lg:items-end">
              <span className="rounded-lg bg-brand-700 px-2.5 py-1 text-[11px] font-semibold text-white">
                {meta.financing.text}
              </span>
